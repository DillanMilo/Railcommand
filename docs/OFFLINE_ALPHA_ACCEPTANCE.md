...
- Documents, scheduling, RailBot, EarthCam live video/feed administration, and other
  online-only mutations must preserve any entered input if connectivity is lost.
  Project-authorized EarthCam feed names may be cached for offline reference, but the
  app never presents cached footage as live and never queues feed add/edit/remove.
