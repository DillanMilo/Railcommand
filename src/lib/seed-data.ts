...
export const seedSubmittals: Submittal[] = [
  ...
  {
    id: 'sub-016', project_id: 'proj-001', number: 'SUB-016', title: 'As-Built Drawing Package — Siding 1 & 2',
    description: 'As-built drawings reflecting final track alignment, grade, and signal conduit routing for completed Sidings 1 and 2. Includes redline markups and survey data.',
    spec_section: '01 78 00 - Closeout Submittals', status: 'submitted',
    submitted_by: 'prof-004', reviewed_by: null, submit_date: '2026-03-18T00:00:00Z',
    due_date: '2026-04-01', review_date: null, review_notes: null,
    milestone_id: null, created_at: '2026-03-18T00:00:00Z',
  },
  {
    id: 'sub-017', project_id: 'proj-001', number: 'SUB-017', title: 'Signal System Test Plan',
    description: 'Comprehensive test plan for wayside signal system including functional tests, fail-safe verification, and integration testing with grade crossing protection.',
    spec_section: '16 11 00 - Signal System Testing', status: 'under_review',
    submitted_by: 'prof-006', reviewed_by: null, submit_date: '2026-03-25T00:00:00Z',
    due_date: '2026-04-08', review_date: null, review_notes: null,
    milestone_id: null, created_at: '2026-03-25T00:00:00Z',
  },
];
...
export const seedRFIs: RFI[] = [
  ...
  {
    id: 'rfi-011', project_id: 'proj-001', number: 'RFI-011', subject: 'Siding 3 Ballast Specification Clarification',
    question: 'Siding 3 ballast specification references AREMA #4 in the plans but the special provisions call out AREMA #4A for turnout areas. Please clarify whether #4 or #4A applies to the #24 turnout zone at STA 32+00.',
    answer: null, status: 'open', priority: 'medium', submitted_by: 'prof-003', assigned_to: 'prof-010',
    submit_date: '2026-03-12T00:00:00Z', due_date: '2026-03-26', response_date: null,
    milestone_id: null, responses: [], created_at: '2026-03-12T00:00:00Z',
  },
  {
    id: 'rfi-012', project_id: 'proj-001', number: 'RFI-012', subject: 'As-Built Survey Control Point Locations',
    question: 'As-built survey requires permanent control points per spec Section 01 71 23. Please confirm acceptable monument types and spacing for the yard expansion area.',
    answer: 'Use brass disc monuments set in concrete at 500\' intervals along mainline alignment. Monuments at all turnout points and curve PCs/PTs. See CDOT survey standards for monument detail.',
    status: 'answered', priority: 'low', submitted_by: 'prof-005', assigned_to: 'prof-010',
    submit_date: '2026-03-20T00:00:00Z', due_date: '2026-04-03', response_date: '2026-04-02T00:00:00Z',
    milestone_id: null, responses: [], created_at: '2026-03-20T00:00:00Z',
  },
];
...
export const seedDailyLogs: DailyLog[] = [
  ...
  // --- March/April 2026 daily logs ---
  {
    id: 'dl-026', project_id: 'proj-001', log_date: '2026-03-03', created_by: 'prof-003',
    weather_temp: 42, weather_conditions: 'Partly cloudy', weather_wind: 'W 10 mph',
    work_summary: 'Siding 3 subgrade prep from STA 0+00 to STA 3+00. Excavator removed 4\' of unsuitable material. Geogrid layout started. Signal crew mounted heads on mast S-3.',
    safety_notes: 'Morning toolbox talk on excavation safety and trench shoring requirements.',
    geo_tag: null, personnel: [], equipment: [], work_items: [],
    created_at: '2026-03-03T17:00:00Z',
  },
  {
    id: 'dl-027', project_id: 'proj-001', log_date: '2026-03-10', created_by: 'prof-004',
    weather_temp: 38, weather_conditions: 'Overcast, light rain/snow mix', weather_wind: 'NW 14 mph',
    work_summary: 'Siding 3 subballast placement STA 0+00 to STA 4+00. Compaction testing passed at 95% Proctor. Signal wiring continued at S-3 and S-4. Grade crossing excavation layout staked.',
    safety_notes: 'Wet conditions — extra caution around slopes. Anti-slip mats placed on equipment access steps.',
    geo_tag: null, personnel: [], equipment: [], work_items: [],
    created_at: '2026-03-10T17:00:00Z',
  },
  {
    id: 'dl-028', project_id: 'proj-001', log_date: '2026-03-17', created_by: 'prof-008',
    weather_temp: 48, weather_conditions: 'Clear, sunny', weather_wind: 'S 6 mph',
    work_summary: 'Concrete tie distribution on Siding 3 complete. Rail threading began at STA 0+00. Grade crossing approach slab formwork set at Main St. Signal cable pull through north conduit run — 1,200 LF of 16AWG quad.',
    safety_notes: '',
    geo_tag: null, personnel: [], equipment: [], work_items: [],
    created_at: '2026-03-17T17:00:00Z',
  },
  {
    id: 'dl-029', project_id: 'proj-001', log_date: '2026-03-24', created_by: 'prof-003',
    weather_temp: 52, weather_conditions: 'Partly cloudy, warm', weather_wind: 'SW 8 mph',
    work_summary: 'Rail installation on Siding 3 reached STA 6+00. Ballast drop ongoing behind rail crew. Grade crossing approach slab poured — 18 CY concrete. Wayside signal functional test at S-1 and S-2 passed.',
    safety_notes: 'Concrete pour safety briefing conducted. Designated wash station set up for crew.',
    geo_tag: null, personnel: [], equipment: [], work_items: [],
    created_at: '2026-03-24T17:00:00Z',
  },
  {
    id: 'dl-030', project_id: 'proj-001', log_date: '2026-03-31', created_by: 'prof-004',
    weather_temp: 45, weather_conditions: 'Overcast, breezy', weather_wind: 'W 16 mph',
    work_summary: 'Siding 3 rail installation past STA 9+00. Initial tamping pass STA 0+00 to 5+00. Grade crossing gate mechanism base plates set. Signal interconnect wiring at controller cabinet 60% complete.',
    safety_notes: 'Wind gusts to 25 mph — crane operations paused from 1-3 PM.',
    geo_tag: null, personnel: [], equipment: [], work_items: [],
    created_at: '2026-03-31T17:00:00Z',
  },
  {
    id: 'dl-031', project_id: 'proj-001', log_date: '2026-04-07', created_by: 'prof-008',
    weather_temp: 55, weather_conditions: 'Clear, warm', weather_wind: 'S 5 mph',
    work_summary: 'Siding 3 rail work nearing STA 12+00. Turnout assembly components staged at STA 32+00. Grade crossing rubber panels delivered — 24 panels on site. Signal controller cabinet power-up test scheduled for Thursday.',
    safety_notes: '',
    geo_tag: null, personnel: [], equipment: [], work_items: [],
    created_at: '2026-04-07T17:00:00Z',
  },
  {
    id: 'dl-032', project_id: 'proj-001', log_date: '2026-04-09', created_by: 'prof-003',
    weather_temp: 60, weather_conditions: 'Sunny, mild', weather_wind: 'SW 4 mph',
    work_summary: 'Began #24 turnout installation at Siding 3. Frog and switch points set. Grade crossing panel installation started — 8 of 24 panels placed. Signal controller cabinet energized and communicating with field devices.',
    safety_notes: 'Turnout installation safety plan reviewed with all crews. Pinch point hazards identified and flagged.',
    geo_tag: null, personnel: [], equipment: [], work_items: [],
    created_at: '2026-04-09T17:00:00Z',
  },
  {
    id: 'dl-033', project_id: 'proj-001', log_date: '2026-04-11', created_by: 'prof-004',
    weather_temp: 58, weather_conditions: 'Partly cloudy', weather_wind: 'W 7 mph',
    work_summary: 'Turnout closure rails and guard rails installed. Ballast tamping on Siding 3 STA 5+00 to 9+00. Grade crossing panel placement continued — 16 of 24 complete. CDOT inspector on site for interim track geometry review.',
    safety_notes: 'Inspector noted missing barricade at south access — corrected within the hour.',
    geo_tag: null, personnel: [], equipment: [], work_items: [],
...
export const seedMilestones: Milestone[] = [
  ...
  { id: 'ms-003', project_id: 'proj-001', name: 'Siding 1 Track Installation', description: 'Tie placement, rail installation, ballast, tamping, and surfacing for Siding 1 (2,400 LF).', target_date: '2025-12-31', actual_date: '2026-01-05', status: 'complete', percent_complete: 100, budget_planned: 520000, budget_actual: 510000, sort_order: 3, linked_submittals: ['sub-001', 'sub-002', 'sub-008', 'sub-011', 'sub-014'], linked_rfis: ['rfi-006'], created_at: '2025-08-26T00:00:00Z' },
  { id: 'ms-004', project_id: 'proj-001', name: 'Siding 2 Track Installation', description: 'Tie placement, rail installation, ballast, tamping, and surfacing for Siding 2 (2,200 LF).', target_date: '2026-01-31', actual_date: '2026-02-08', status: 'complete', percent_complete: 100, budget_planned: 520000, budget_actual: 535000, sort_order: 4, linked_submittals: ['sub-001', 'sub-002'], linked_rfis: ['rfi-002'], created_at: '2025-08-26T00:00:00Z' },
  { id: 'ms-005', project_id: 'proj-001', name: 'Siding 3 Track Installation', description: 'Tie placement, rail installation, ballast, tamping, and surfacing for Siding 3 (2,000 LF). Includes #24 turnout.', target_date: '2026-02-15', actual_date: null, status: 'on_track', percent_complete: 65, budget_planned: 520000, budget_actual: 340000, sort_order: 5, linked_submittals: ['sub-003', 'sub-010'], linked_rfis: ['rfi-004', 'rfi-005', 'rfi-010'], created_at: '2025-08-26T00:00:00Z' },
  { id: 'ms-006', project_id: 'proj-001', name: 'Signal Foundation & Conduit', description: 'Signal mast foundations, conduit installation, junction boxes, and cable pulls.', target_date: '2026-01-15', actual_date: '2026-02-20', status: 'complete', percent_complete: 100, budget_planned: 380000, budget_actual: 395000, sort_order: 6, linked_submittals: ['sub-005', 'sub-012'], linked_rfis: ['rfi-001', 'rfi-003'], created_at: '2025-08-26T00:00:00Z' },
  { id: 'ms-007', project_id: 'proj-001', name: 'Wayside Signal Installation', description: 'Signal mast erection, signal head mounting, wiring, and initial testing.', target_date: '2026-02-10', actual_date: null, status: 'on_track', percent_complete: 75, budget_planned: 450000, budget_actual: 340000, sort_order: 7, linked_submittals: ['sub-006', 'sub-009', 'sub-015'], linked_rfis: ['rfi-008'], created_at: '2025-08-26T00:00:00Z' },
  { id: 'ms-008', project_id: 'proj-001', name: 'Grade Crossing Installation', description: 'Crossing surface, gate mechanisms, signals, interconnect, and advance warning signs at Main St.', target_date: '2026-02-20', actual_date: null, status: 'at_risk', percent_complete: 30, budget_planned: 680000, budget_actual: 210000, sort_order: 8, linked_submittals: ['sub-007', 'sub-013'], linked_rfis: ['rfi-007'], created_at: '2025-08-26T00:00:00Z' },
  { id: 'ms-009', project_id: 'proj-001', name: 'Testing & Commissioning', description: 'Signal system testing, track geometry verification, load testing, and system integration.', target_date: '2026-02-22', actual_date: null, status: 'not_started', percent_complete: 5, budget_planned: 320000, budget_actual: 15000, sort_order: 9, linked_submittals: [], linked_rfis: [], created_at: '2025-08-26T00:00:00Z' },
...
export const seedChangeOrders: ChangeOrder[] = [
  {
    id: 'co-001', project_id: 'proj-001', number: 'CO-001',
    title: 'Additional Subballast at Siding 2',
    description: 'Unsuitable soil conditions discovered at Siding 2 STA 3+00 to 5+50 require additional 6" of subballast beyond original design.',
    reason: 'Unforeseen conditions',
    amount: 45000,
    status: 'approved',
    submitted_by: 'prof-003',
    approved_by: 'prof-001',
    linked_milestone_id: 'ms-004',
    submit_date: '2025-11-15',
    approval_date: '2025-11-20',
    created_at: '2025-11-15T00:00:00Z',
  },
  {
    id: 'co-002', project_id: 'proj-001', number: 'CO-002',
    title: 'Signal Conduit Re-route — Existing Utility Conflict',
    description: 'Existing 8" water main found at planned conduit route. Reroute adds 340 LF of conduit and 2 additional junction boxes.',
    reason: 'Design conflict',
    amount: 28500,
    status: 'approved',
    submitted_by: 'prof-006',
    approved_by: 'prof-001',
    linked_milestone_id: 'ms-006',
    submit_date: '2025-12-10',
    approval_date: '2025-12-18',
    created_at: '2025-12-10T00:00:00Z',
  },
  {
    id: 'co-003', project_id: 'proj-001', number: 'CO-003',
    title: 'Delete Siding 3 Turnout Heater',
    description: 'Owner directed removal of switch heater at Siding 3 #24 turnout. Heater to be installed in future phase.',
    reason: 'Owner directive',
    amount: -18000,
    status: 'approved',
    submitted_by: 'prof-001',
    approved_by: 'prof-001',
    linked_milestone_id: 'ms-005',
    submit_date: '2026-01-05',
    approval_date: '2026-01-08',
    created_at: '2026-01-05T00:00:00Z',
  },
  {
    id: 'co-004', project_id: 'proj-001', number: 'CO-004',
    title: 'Grade Crossing Precast Panel Upgrade',
    description: 'Upgrade crossing surface panels from timber to precast concrete per revised CDOT requirements.',
    reason: 'Regulatory change',
    amount: 62000,
    status: 'submitted',
    submitted_by: 'prof-003',
    approved_by: null,
    linked_milestone_id: 'ms-008',
    submit_date: '2026-02-01',
    approval_date: null,
    created_at: '2026-02-01T00:00:00Z',
  },
  {
    id: 'co-005', project_id: 'proj-001', number: 'CO-005',
    title: 'Additional Track Geometry Survey',
    description: 'Owner requests additional track geometry survey for Siding 1 after settlement concerns raised by inspector.',
    reason: 'Owner request',
    amount: 8500,
    status: 'draft',
    submitted_by: 'prof-004',
    approved_by: null,
    linked_milestone_id: 'ms-003',
...
export const seedWeeklyReports: WeeklyReport[] = [
  {
    id: 'wr-001', project_id: 'proj-001', number: 'WR-001',
    report_type: 'cm',
    week_start_date: '2026-02-03', week_end_date: '2026-02-09',
    title: 'CM Weekly — Siding 1 Track & Signal Conduit',
    status: 'approved',
    work_summary: 'Siding 1 track installation reached STA 18+00, ballast placement complete to STA 16+00. Signal conduit trenching at 60% along the planned route. OTM tie program on schedule.',
    safety_summary: 'Zero incidents. Weekly toolbox talk on trenching safety conducted Tuesday. All crews current on PPE inspections.',
    schedule_summary: 'Siding 1 on track for December completion. Signal conduit reroute (CO-002) added 2 days but absorbed in float. Wayside signal delivery delayed — monitoring.',
    issues_concerns: 'Wayside signal head delivery pushed to Feb 20. Coordinating with Front Range Signal on revised install sequence. May impact MS-007 milestone.',
    upcoming_work: 'Continue Siding 1 surfacing and tamping. Begin Siding 2 tie distribution. Signal conduit junction box installation.',
    weather_summary: 'Mon–Wed clear, 38–45°F. Thu snow (3"), Fri clear. No weather days lost.',
    manpower_total: 42,
    equipment_hours: 380,
    submitted_by: 'prof-001',
    approved_by: 'prof-010',
    submit_date: '2026-02-09',
    approval_date: '2026-02-11',
    created_at: '2026-02-09T17:00:00Z',
  },
  {
    id: 'wr-002', project_id: 'proj-001', number: 'WR-002',
    report_type: 'contractor',
    week_start_date: '2026-02-03', week_end_date: '2026-02-09',
    title: 'Contractor Weekly — Mountain West Track Services',
    status: 'approved',
    work_summary: 'Installed 800 LF of 136RE rail on Siding 1. Placed 320 concrete ties. Ballast drop of 450 tons. Tamping and surfacing from STA 12+00 to STA 16+00.',
    safety_summary: 'Pre-shift briefings daily. One near-miss reported (swinging rail section near crew) — corrective action: designated swing zone implemented.',
    schedule_summary: 'Siding 1 work tracking 2 days ahead of baseline. Siding 2 tie delivery confirmed for next week.',
    issues_concerns: 'Ballast supplier reporting potential shortage of #4 ballast in March. Requesting advance order of 2,000 tons.',
    upcoming_work: 'Complete Siding 1 surfacing STA 16+00 to 20+00. Begin tie placement on Siding 2. Thermite welding on completed Siding 1 joints.',
    weather_summary: 'Lost half day Thursday due to snow. Otherwise clear and workable. Low temps slowing ballast compaction.',
    manpower_total: 28,
    equipment_hours: 245,
    submitted_by: 'prof-003',
    approved_by: 'prof-001',
  ...
  {
    id: 'wr-003', project_id: 'proj-001', number: 'WR-003',
    report_type: 'cm',
    week_start_date: '2026-02-10', week_end_date: '2026-02-16',
    title: 'CM Weekly — Signal Reroute & Siding 2 Start',
    status: 'submitted',
    work_summary: 'Signal conduit reroute around water main complete. Siding 2 subgrade prep started at STA 1+00. Three RFIs answered this week (RFI-009, RFI-010, RFI-002).',
    safety_summary: 'One observation logged: unsecured material storage near track. Corrected same day. Safety audit by CDOT inspector passed.',
    schedule_summary: 'Signal conduit milestone at 65%. Siding 2 earthwork starting on schedule. Grade crossing panel submittal under review — need approval by Feb 21.',
    issues_concerns: 'Grade crossing panel submittal (SUB-013) still under review. If not approved by Feb 21, crossing installation schedule at risk.',
    upcoming_work: 'Signal junction box wiring. Siding 2 geogrid installation. Crossing surface panel mock-up if submittal approved.',
    weather_summary: 'Clear all week, temps 30–42°F. Ground frost to 4" depth — no impact on current work.',
    manpower_total: 45,
    equipment_hours: 410,
    submitted_by: 'prof-001',
    approved_by: null,
  ...
  {
    id: 'wr-004', project_id: 'proj-001', number: 'WR-004',
    report_type: 'contractor',
    week_start_date: '2026-02-10', week_end_date: '2026-02-16',
    title: 'Contractor Weekly — Signal & Track Work',
    status: 'draft',
    work_summary: 'Signal conduit pull completed for junction boxes JB-1 through JB-4. Siding 2 excavation started. Siding 1 thermite welds — 12 joints completed.',
    safety_summary: 'Pre-shift briefings daily. No incidents. Reviewed arc flash procedures for signal wiring.',
    schedule_summary: 'Signal conduit ahead of revised schedule. Siding 2 earthwork on track. Thermite welding progressing.',
    issues_concerns: 'Need clarification on switch machine power routing for Siding 3 turnout (RFI-008 pending).',
    upcoming_work: 'Continue signal wiring. Siding 2 subballast placement. Complete remaining thermite welds on Siding 1.',
    weather_summary: 'Cold but clear. Frost delays morning starts by ~30 min.',
    manpower_total: 24,
    equipment_hours: 195,
    submitted_by: 'prof-006',
    approved_by: null,
...
// ============================================================
// MODIFICATIONS & AMENDMENTS (5)
// ============================================================
export const seedModifications: Modification[] = [
  {
    id: 'mod-001', project_id: 'proj-001', number: 'MOD-001',
    title: 'Track Alignment Revision — Siding 2 STA 3+00 to 5+50',
    description: 'Revised horizontal alignment to avoid discovered utility conflict (8" water main). Shifts centerline 6 ft south. Updated plan sheets and profile.',
    modification_type: 'plan_revision',
    status: 'implemented',
    revision_number: 'Rev 2',
    affected_documents: 'Sheet T-201, T-202, Profile P-201',
    issued_by: 'prof-010',
    issued_date: '2025-11-20',
    effective_date: '2025-12-01',
    acknowledged_by: 'prof-001',
    acknowledged_date: '2025-11-22',
    linked_milestone_id: 'ms-004',
    created_at: '2025-11-20T00:00:00Z',
  },
  {
    id: 'mod-002', project_id: 'proj-001', number: 'MOD-002',
    title: 'Signal Conduit Specification Amendment',
    description: 'Updated conduit specification from Schedule 40 PVC to Schedule 80 PVC per AREMA signal guideline update. Applies to all new signal conduit installations.',
    modification_type: 'spec_amendment',
    status: 'acknowledged',
    revision_number: 'Amendment A',
    affected_documents: 'Spec 16 11 00 Section 2.1, Signal Conduit Detail SD-301',
    issued_by: 'prof-010',
    issued_date: '2025-12-15',
    effective_date: null,
    acknowledged_by: 'prof-006',
    acknowledged_date: '2025-12-18',
    linked_milestone_id: 'ms-006',
    created_at: '2025-12-15T00:00:00Z',
  },
  {
    id: 'mod-003', project_id: 'proj-001', number: 'MOD-003',
    title: 'Grade Crossing Panel Type Change',
    description: 'CDOT requires upgrade from timber crossing panels to precast concrete panels per revised regulatory requirements effective January 2026.',
    modification_type: 'design_change',
    status: 'issued',
    revision_number: 'Rev 1',
    affected_documents: 'Sheet GC-401, GC-402, Detail GC-D1, Spec 32 17 23',
    issued_by: 'prof-010',
  ...
  {
    id: 'mod-004', project_id: 'proj-001', number: 'MOD-004',
    title: 'Contract Amendment — Extended Completion Date',
    description: 'Owner-directed extension of substantial completion date from Feb 26 to Mar 15, 2026 due to signal equipment supply chain delays. No liquidated damages applied for the extension period.',
    modification_type: 'contract_amendment',
    status: 'implemented',
    revision_number: 'Amendment 1',
    affected_documents: 'Contract Section 00 52 00, Schedule of Work',
    issued_by: 'prof-001',
    issued_date: '2026-01-10',
    effective_date: '2026-01-12',
    acknowledged_by: 'prof-003',
    acknowledged_date: '2026-01-11',
    linked_milestone_id: null,
    created_at: '2026-01-10T00:00:00Z',
  },
  {
    id: 'mod-005', project_id: 'proj-001', number: 'MOD-005',
    title: 'Siding 3 Turnout Scope Reduction',
    description: 'Owner directed removal of switch heater system from Siding 3 #24 turnout scope. Heater to be installed in a future construction phase. Associated CO-003 approved.',
    modification_type: 'scope_change',
    status: 'draft',
    revision_number: 'Rev 1',
    affected_documents: 'Sheet T-301, Spec 34 71 13.19, Turnout Detail TD-301',
    issued_by: 'prof-001',
...
// QC/QA REPORTS (5)
// ============================================================
export const seedQCQAReports: QCQAReport[] = [
  {
    id: 'qc-001', project_id: 'proj-001', number: 'QC-001',
    report_type: 'inspection',
    title: 'Track Gauge Inspection — Siding 1 STA 8+00 to 12+00',
    description: 'Pre-ballast track gauge inspection per AREMA standards. Verified gauge at 25-ft intervals.',
    spec_reference: '34 11 13 Section 3.2',
    location: 'Siding 1, STA 8+00 to 12+00',
    status: 'closed',
    findings: 'All gauge measurements within tolerance (56-1/2" +/- 1/4"). Two locations at STA 9+25 and 10+50 measured 56-1/4" (tight but within spec). No deficiencies noted.',
    corrective_action: 'No corrective action required. Monitoring locations flagged for re-check after ballast tamping.',
    is_nonconformance: false,
    severity: 'minor',
    inspector: 'prof-009',
    inspector_profile: { id: 'prof-009', email: 'pat.morrison@codot.gov', full_name: 'Patricia Morrison', phone: '(303) 555-0501', role: 'viewer', organization_id: 'org-005', avatar_url: '', created_at: '2025-01-01T00:00:00Z' },
    linked_punch_list_ids: ['pl-010'],
    closed_by: 'prof-001',
    closed_date: '2026-01-20T00:00:00Z',
    created_at: '2026-01-15T10:00:00Z',
  },
  {
    id: 'qc-002', project_id: 'proj-001', number: 'QC-002',
    report_type: 'test',
    title: 'Ballast Gradation Test — Siding 1 Stockpile',
    description: 'Sieve analysis of #4 ballast material from on-site stockpile per AREMA specification.',
    spec_reference: '34 11 13.13 Section 2.3',
    location: 'Siding 1 ballast stockpile area',
    status: 'closed',
    findings: 'Gradation results: 3" - 100%, 2" - 92%, 1-1/2" - 68%, 3/4" - 18%, 1/2" - 4%. All within AREMA #4 specification limits. Fractured faces >90%. LA Abrasion 22% (max 40%).',
    corrective_action: 'None required. Material approved for use.',
    is_nonconformance: false,
    severity: 'minor',
    inspector: 'prof-009',
    inspector_profile: { id: 'prof-009', email: 'pat.morrison@codot.gov', full_name: 'Patricia Morrison', phone: '(303) 555-0501', role: 'viewer', organization_id: 'org-005', avatar_url: '', created_at: '2025-01-01T00:00:00Z' },
    ...
    closed_by: 'prof-001',
    closed_date: '2026-01-28T00:00:00Z',
    created_at: '2026-01-25T14:00:00Z',
  },
  {
    id: 'qc-003', project_id: 'proj-001', number: 'QC-003',
    report_type: 'nonconformance',
    title: 'Signal Conduit Material Nonconformance — Schedule 40 vs. 80',
    description: 'Nonconformance report for Schedule 40 PVC conduit installed instead of required Schedule 80 PVC per MOD-002 amendment.',
    spec_reference: '16 11 00 Section 2.1',
    location: 'Signal conduit run JB-3 to JB-4',
    status: 'open',
    findings: 'Approximately 180 LF of Schedule 40 PVC conduit was installed between junction boxes JB-3 and JB-4 prior to the specification amendment (MOD-002) taking effect. The installed conduit does not meet the updated Schedule 80 requirement.',
    corrective_action: 'Options under review: (1) Remove and replace with Schedule 80 PVC, (2) Engineer evaluation for equivalency waiver. Awaiting RFI response from engineer of record.',
    is_nonconformance: true,
    severity: 'major',
    inspector: 'prof-009',
    inspector_profile: { id: 'prof-009', email: 'pat.morrison@codot.gov', full_name: 'Patricia Morrison', phone: '(303) 555-0501', role: 'viewer', organization_id: 'org-005', avatar_url: '', created_at: '2025-01-01T00:00:00Z' },
    linked_punch_list_ids: ['pl-011'],
    closed_by: null,
    closed_date: null,
    created_at: '2026-02-05T09:00:00Z',
  },
  {
    id: 'qc-004', project_id: 'proj-001', number: 'QC-004',
    report_type: 'audit',
    title: 'Thermite Weld Procedure Audit — Siding 1',
    description: 'Field audit of thermite welding procedures and crew qualifications per AREMA and project specifications.',
    spec_reference: '34 11 13.16 Section 3.5',
    location: 'Siding 1, various weld locations',
    status: 'in_review',
    findings: 'Crew certifications current (verified 3 welders). Preheat procedures followed correctly. Crucible alignment verified. One weld at STA 10+20 had excess collar material — punch list item created (PL-012). 11 of 12 welds inspected passed visual and straightedge check.',
    corrective_action: 'PL-012 issued for weld collar grinding at STA 10+20. Recommend re-audit after Siding 2 welding begins.',
    is_nonconformance: false,
    severity: 'minor',
    inspector: 'prof-009',
    inspector_profile: { id: 'prof-009', email: 'pat.morrison@codot.gov', full_name: 'Patricia Morrison', phone: '(303) 555-0501', role: 'viewer', organization_id: 'org-005', avatar_url: '', created_at: '2025-01-01T00:00:00Z' },
    linked_punch_list_ids: ['pl-012'],
    closed_by: null,
    closed_date: null,
    created_at: '2026-02-10T11:00:00Z',
  },
  {
    id: 'qc-005', project_id: 'proj-001', number: 'QC-005',
    report_type: 'inspection',
    title: 'Grade Crossing Panel Pre-Installation Inspection',
    description: 'Pre-installation inspection of precast concrete crossing panels received on-site. Verify dimensions, surface condition, and embedded hardware.',
    spec_reference: '32 17 23 Section 2.2',
    location: 'Main St. Grade Crossing staging area',
    status: 'draft',
    findings: '',
    corrective_action: '',
    is_nonconformance: false,
...
export const seedProjectDocuments: ProjectDocument[] = [
  {
    id: 'doc-001', project_id: 'proj-001', number: 'DOC-001',
    title: 'Track Layout Plan — Siding 1, 2, 3',
    description: 'Master track layout plan showing horizontal and vertical alignments for all three sidings, including turnout locations, curve data, and stationing.',
    category: 'drawing',
    status: 'approved',
    revision: 'Rev 2',
    revision_date: '2026-01-10',
    file_name: 'T-100_Track_Layout_Plan_Rev2.pdf',
    file_url: '',
    file_size: 4_850_000,
    uploaded_by: 'prof-010',
    uploaded_by_profile: { id: 'prof-010', full_name: 'Dr. Nathan Park' },
    reviewed_by: 'prof-001',
    reviewed_by_profile: { id: 'prof-001', full_name: 'Mark Sullivan' },
    review_date: '2026-01-12',
    linked_milestone_id: 'ms-003',
    created_at: '2025-10-15T10:00:00Z',
  },
  {
    id: 'doc-002', project_id: 'proj-001', number: 'DOC-002',
    title: 'Signal Conduit Installation Spec',
    description: 'Specification for signal conduit installation including Schedule 80 PVC requirements per AREMA guidelines, burial depth, and bending radius.',
    category: 'specification',
    status: 'issued',
    revision: 'Rev 1',
    revision_date: '2025-12-18',
    file_name: '16_11_00_Signal_Conduit_Spec_Rev1.pdf',
    file_url: '',
    file_size: 1_240_000,
    uploaded_by: 'prof-010',
    uploaded_by_profile: { id: 'prof-010', full_name: 'Dr. Nathan Park' },
  ...
  {
    id: 'doc-003', project_id: 'proj-001', number: 'DOC-003',
    title: 'Subgrade Geotechnical Report',
    description: 'Geotechnical investigation report for subgrade conditions at all three siding locations. Includes bore logs, lab results, and design recommendations.',
    category: 'report',
    status: 'approved',
    revision: 'Rev 0',
    revision_date: '2025-08-20',
    file_name: 'Geotech_Report_Englewood_Yard.pdf',
    file_url: '',
  ...
  {
    id: 'doc-004', project_id: 'proj-001', number: 'DOC-004',
    title: 'Grade Crossing Gate Mechanism Submittal',
    description: 'Shop drawing submittal for grade crossing gate mechanisms including drive unit specifications, arm lengths, and counterweight calculations.',
    category: 'submittal',
    status: 'under_review',
    revision: 'Rev A',
    revision_date: '2026-02-10',
    file_name: 'GC_Gate_Mechanism_Submittal_RevA.pdf',
    file_url: '',
    file_size: 3_200_000,
    uploaded_by: 'prof-006',
    uploaded_by_profile: { id: 'prof-006', full_name: 'Derek Washington' },
    reviewed_by: null,
    review_date: null,
    linked_milestone_id: 'ms-008',
    created_at: '2026-02-10T11:00:00Z',
  ...
  {
    id: 'doc-005', project_id: 'proj-001', number: 'DOC-005',
    title: 'Construction Contract — Phase 2',
    description: 'Executed construction contract for Englewood Yard Expansion Phase 2 including general conditions, special provisions, and schedule of work.',
    category: 'contract',
    status: 'approved',
    revision: 'Rev 0',
    revision_date: '2025-07-15',
    file_name: 'Contract_Englewood_Phase2.pdf',
    file_url: '',
    file_size: 8_450_000,
    uploaded_by: 'prof-001',
    uploaded_by_profile: { id: 'prof-001', full_name: 'Mark Sullivan' },
    reviewed_by: 'prof-001',
    reviewed_by_profile: { id: 'prof-001', full_name: 'Mark Sullivan' },
  ...
  {
    id: 'doc-006', project_id: 'proj-001', number: 'DOC-006',
    title: 'Weekly Progress Photos — March 2026',
    description: 'Compilation of weekly progress photos documenting Siding 3 subgrade work, signal mast installation, and grade crossing preparation.',
    category: 'photo_log',
    status: 'draft',
    revision: 'Rev 0',
    revision_date: '2026-03-28',
    file_name: 'Progress_Photos_March_2026.zip',
    file_url: '',
    file_size: 156_800_000,
    uploaded_by: 'prof-004',
    uploaded_by_profile: { id: 'prof-004', full_name: 'Travis Mitchell' },
    reviewed_by: null,
    review_date: null,
    linked_milestone_id: null,
...
export const seedActivityLog: ActivityLogEntry[] = [
  ...
  // --- March/April 2026 activity ---
  { id: 'act-031', project_id: 'proj-001', entity_type: 'daily_log', entity_id: 'dl-026', action: 'created', description: 'Daily log created for Mar 3, 2026 — Siding 3 subgrade and signal head mounting', performed_by: 'prof-003', created_at: '2026-03-03T17:15:00Z' },
  { id: 'act-032', project_id: 'proj-001', entity_type: 'milestone', entity_id: 'ms-003', action: 'status_changed', description: 'Siding 1 Track Installation marked complete', performed_by: 'prof-001', created_at: '2026-03-05T09:00:00Z' },
  { id: 'act-033', project_id: 'proj-001', entity_type: 'submittal', entity_id: 'sub-016', action: 'submitted', description: 'As-Built Drawing Package for Siding 1 & 2 submitted', performed_by: 'prof-004', created_at: '2026-03-18T10:00:00Z' },
  { id: 'act-034', project_id: 'proj-001', entity_type: 'rfi', entity_id: 'rfi-011', action: 'created', description: 'RFI-011: Siding 3 ballast specification clarification', performed_by: 'prof-003', created_at: '2026-03-12T08:30:00Z' },
  { id: 'act-035', project_id: 'proj-001', entity_type: 'punch_list', entity_id: 'pl-003', action: 'status_changed', description: 'Signal cable splice box at JB-3 sealed and verified', performed_by: 'prof-006', created_at: '2026-03-14T14:00:00Z' },
  { id: 'act-036', project_id: 'proj-001', entity_type: 'submittal', entity_id: 'sub-017', action: 'submitted', description: 'Signal System Test Plan submitted for review', performed_by: 'prof-006', created_at: '2026-03-25T09:00:00Z' },
  { id: 'act-037', project_id: 'proj-001', entity_type: 'milestone', entity_id: 'ms-006', action: 'status_changed', description: 'Signal Foundation & Conduit marked complete', performed_by: 'prof-001', created_at: '2026-03-28T10:00:00Z' },
  { id: 'act-038', project_id: 'proj-001', entity_type: 'daily_log', entity_id: 'dl-032', action: 'created', description: 'Daily log created for Apr 9, 2026 — turnout installation and grade crossing panels', performed_by: 'prof-003', created_at: '2026-04-09T17:15:00Z' },
  { id: 'act-039', project_id: 'proj-001', entity_type: 'rfi', entity_id: 'rfi-012', action: 'status_changed', description: 'RFI-012 answered: As-built survey control point locations', performed_by: 'prof-010', created_at: '2026-04-02T11:00:00Z' },
  { id: 'act-040', project_id: 'proj-001', entity_type: 'milestone', entity_id: 'ms-008', action: 'updated', description: 'Grade Crossing Installation progress updated to 30% — at risk', performed_by: 'prof-001', created_at: '2026-04-12T08:00:00Z' },
];
