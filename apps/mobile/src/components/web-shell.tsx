...
const styles = StyleSheet.create({
  ...
  projectName: { flex: 1, minWidth: 0, color: colors.white, fontFamily: fonts.bodyMedium, fontSize: 15, lineHeight: 20 },
  ...
  breadcrumbText: { color: colors.muted, fontFamily: fonts.body, fontSize: 15, lineHeight: 21 },
  breadcrumbCurrent: { flexShrink: 1, color: colors.ink, fontFamily: fonts.bodyBold, fontSize: 15, lineHeight: 21 },
  heading: { gap: 8 },
  titleRow: { flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center', gap: 10 },
  headingTitle: { color: colors.ink, fontFamily: fonts.headingHeavy, fontSize: 29, lineHeight: 36, letterSpacing: -1.1 },
  ...
  actionButtonText: { color: colors.ink, fontFamily: fonts.bodyMedium, fontSize: 15, lineHeight: 20 },
  actionButtonTextPrimary: { color: colors.white },
  disabled: { opacity: 0.42 },
  filterTabs: { minHeight: 54, flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: colors.line },
  filterTab: { flex: 1, minHeight: 54, alignItems: 'center', justifyContent: 'center', borderBottomWidth: 2, borderBottomColor: 'transparent', paddingHorizontal: 4 },
  ...
  emptyText: { color: colors.muted, fontFamily: fonts.body, fontSize: 16, lineHeight: 22, textAlign: 'center' },
  railbot: { position: 'absolute', right: 18, bottom: 18, width: 58, height: 58, borderRadius: 29, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.orange, shadowColor: colors.ink, shadowOpacity: 0.16, shadowRadius: 12, shadowOffset: { width: 0, height: 6 }, elevation: 6 },
});
