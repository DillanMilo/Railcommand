...
export default function TeamScreen() {
  ...
  const team = recordsForProject(bootstrap?.team, activeProjectId);
  ...
  return <Screen>
    ...
    <PageHeading eyebrow="PROJECT ACCESS / TEAM" title="Project Team"
      badge={`${team.length} CACHED`} detail="People and field roles synchronized for this project." />
    ...
    {team.length ? team.map((member) => <View key={member.id} style={styles.member}>
